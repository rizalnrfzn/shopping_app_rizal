...
class _$UserImpl extends _User {
  _$UserImpl(
      ...
      @HiveField(5) required this.avatar})
      : super._();
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, password: $password, role: $role, avatar: $avatar)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, email, password, role, avatar);
...
abstract class _User extends User {
  factory _User(
      ...
      @HiveField(5) required final String avatar}) = _$UserImpl;
  _User._() : super._();
