...
/// @nodoc
@JsonSerializable()
class _$LoginParamImpl extends _LoginParam {
  _$LoginParamImpl({required this.email, required this.password}) : super._();
...
abstract class _LoginParam extends LoginParam {
  factory _LoginParam(
      {required final String email,
      required final String password}) = _$LoginParamImpl;
  _LoginParam._() : super._();
